...
@register('mamba_composers_inr_ca')
class MambaInr(torch.nn.Module):
    
    def __init__(self, tokenizer, hyponet, mamba_encoder, gen_layers = [0], num_lp = 128, type = 'equidistant', n_group = 1, latent_token_len = 64):
        super().__init__()
