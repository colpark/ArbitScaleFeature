...
@register('lainr_mlp_bias_fmri')
class LAINRDecoder(nn.Module):
    def __init__(self, feature_dim, input_dim, output_dim, sigma_q, sigma_ls, n_patches, hidden_dim = 256, context_dim = None, alpha = 10.0):
        super().__init__()
    ...
    def forward(self, x, tokens, shape, biased = True):
