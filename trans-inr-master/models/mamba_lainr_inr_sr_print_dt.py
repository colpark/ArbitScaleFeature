...
@register('mamba_lainr_inr_sr_print_dt')
class MambaInr(torch.nn.Module):
    
    def __init__(self, tokenizer, hyponet, mamba_encoder, num_lp = 128, type = 'equidistant', n_group = 1, latent_token_len = 64):
        super().__init__()
    ...
    def forward(self, data):
        ...
        mamba_out, features, dts, dts_lr = self.mamba_encoder(all_tokens)
        with open('./features_dts.pkl', 'wb') as file:
                pickle.dump((features, dts, dts_lr), file)
