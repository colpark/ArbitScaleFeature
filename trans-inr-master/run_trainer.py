...
def main_worker(rank, cfg):
    ...
    trainer_entry = cfg['trainer']
    
    if isinstance(trainer_entry, dict):
        trainer_name = trainer_entry['name']
        trainer_args = trainer_entry.get('args', {})
    else:
        trainer_name = trainer_entry
        trainer_args = {}

    trainer = trainers.trainers_dict[trainer_name](rank, cfg, **trainer_args)
    trainer.run()
