...
root_path="/pscratch/sd/t/tbalasoo/MAMBAINR/trans-inr-master"  # change here
cd $root_path
...
run() {
    ...
    TORCH_DISTRIBUTED_DEBUG=DETAIL python run_trainer_slurm.py --cfg "/pscratch/sd/t/tbalasoo/MAMBAINR/trans-inr-master/cfgs/$config"
